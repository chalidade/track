<div class="row p-side-20">
  ...
  <div class="col-12 text-center">
    ...
    <h1 class="sub-title" style="margin-top:20px">Chalid Ade Rahman</h1>
    <p style="margin-top:-10px">chalidade@gmail.com <br><span class="blue-dark-bg text-light" style="padding:0px 5px;border-radius:5px;font-size:11px">085784566522</span></p>
...
<div class="p-side-20">
  <a href="" type="button" class="btn bg-success text-light" name="button" style="font-size:12px;width:100%">TRACK CUSTOMER SERVICE</a>
</div>
<hr style="width:30%">
